...
class Board:
    ...
    def empty_neighbors(self, pos: HexPos):
        """
        Returns the number of empty neighboring cells for a given cell.
        """
        ...
        for direction in directions:
            r, q = pos.r + direction[0], pos.q + direction[1]
            try:
                neighbor = HexPos(r, q)
            except ValueError:
                continue
            if self._state[neighbor].player is None:
                empty_count += 1
